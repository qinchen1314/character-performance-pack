...
def _passing_automatic() -> AutomaticEvidence:
    return AutomaticEvidence(
        ...
        span_accuracy=0.99,
        rewrite_grammar_integrity_rate=1.0,
        rewrite_dialogue_preservation_rate=1.0,
        rewrite_fact_preservation_rate=1.0,
...
def test_each_required_automatic_threshold_is_a_hard_gate() -> None:
    ...
    for field, failing_value in {
        ...
        "span_accuracy": 0.97,
        "rewrite_grammar_integrity_rate": 0.99,
        "rewrite_dialogue_preservation_rate": 0.99,
        "rewrite_fact_preservation_rate": 0.99,
